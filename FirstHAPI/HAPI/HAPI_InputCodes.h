...
// Note: numbers are the same as ASCII '0' - '9' as are the letters 'A' - 'Z'
...
#define HK_LMENU          0xA4
#define HK_RMENU          0xA5
...
// GP2X and Xbox 360 controller (Xb360) codes for digital buttons
// Note: not all are available for each - see the comments
...
#define HK_DIGITAL_BACK					5	// Back on Xb360
#define HK_DIGITAL_SELECT				5	// Select on GP2X
...
#define HK_DIGITAL_VOL_UP				14	// Volume up on GP2X only
#define HK_DIGITAL_VOL_DOWN				15	// Volume down on GP2X only

// Analogue buttons (only on Xb360)
...
// Gamepad thresholds, added in 1.30
